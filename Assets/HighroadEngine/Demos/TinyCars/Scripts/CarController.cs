...
namespace MoreMountains.HighroadEngine
{
	...
	public class CarController : BaseController
	{
		...
		{
			if (_rigidbody.linearVelocity.magnitude > MaximumVelocity) 
			{
			...
			{
				if (_rigidbody.linearVelocity.magnitude > ( MaximumVelocity / OffroadFactor))
				{
			...
			_rigidbody.linearVelocity = _rigidbody.linearVelocity + (transform.forward * force * Time.fixedDeltaTime);
		...
		protected virtual void Brake() 
		{
			...
			{
				// we apply the new velocity
				_rigidbody.linearVelocity = _rigidbody.linearVelocity - (transform.forward * BrakeForce * Time.fixedDeltaTime);	        
			}
	    }
